...
class generateDataset(Dataset):
    ...
    def smiles2tensor(self, smi_data, vocab, aug_mode, aug_num):
        new_lines = []
        max_len = 0
            ...
            if aug_mode =='SMILES':
                ...
                # for j in range(aug_num):
                    ...
                    if smi_j in aug_smi_list: 
                        if len(aug_smi_list) == 1: pass # Some molecules only have one SMILES like C1CCCC1.
                        else: 
                            # print(smi, 'continue: ', aug_smi_list)
                            continue
    ...
    def formula2tensor(self, formula_data, vocab, aug_mode, aug_num):
